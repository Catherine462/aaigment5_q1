...
public class LoginControl extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (userName.equals("")) {
				throw new MessageException("Username not entered");
			} else if (password.equals("")) {
				throw new MessageException("Password not entered");
			} 
			...
			if (e.getMessage().equals("Please enter username")) {
				request.setAttribute("ErrorLogin", "Username not entered");
				address = "/view/LoginView.jsp";
			} else if (e.getMessage().equals("Please enter password")) {
				request.setAttribute("ErrorLogin", "Password not entered");
				address = "/view/LoginView.jsp";	
